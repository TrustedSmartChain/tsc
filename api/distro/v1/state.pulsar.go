...
func init() {
	...
	md_ExampleData = File_distro_v1_state_proto.Messages().ByName("ExampleData")
...
func (x *fastReflection_ExampleData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "distro.v1.ExampleData.account":
		return len(x.Account) != 0
	case "distro.v1.ExampleData.amount":
		return x.Amount != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: distro.v1.ExampleData"))
		}
		panic(fmt.Errorf("message distro.v1.ExampleData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ExampleData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message distro.v1.ExampleData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ExampleData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "distro.v1.ExampleData.account":
		panic(fmt.Errorf("field account of message distro.v1.ExampleData is not mutable"))
	case "distro.v1.ExampleData.amount":
		panic(fmt.Errorf("field amount of message distro.v1.ExampleData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: distro.v1.ExampleData"))
		}
...
func (x *fastReflection_ExampleData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in distro.v1.ExampleData", d.FullName()))
	}
	panic("unreachable")
}
...
var file_distro_v1_state_proto_rawDesc = []byte{
	...
	0x0a, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x10, 0x01, 0x18, 0x01, 0x42, 0x99, 0x01,
	0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x64, 0x69, 0x73, 0x74, 0x72, 0x6f, 0x2e, 0x76, 0x31, 0x42,
	0x0a, 0x53, 0x74, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x37, 0x67,
...
var file_distro_v1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_distro_v1_state_proto_goTypes = []interface{}{
	(*ExampleData)(nil), // 0: distro.v1.ExampleData
}
