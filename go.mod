...
// overrides
replace (
	// Force use of newer cosmossdk.io/api to avoid ORM issues
	// cosmossdk.io/api => cosmossdk.io/api v0.9.2
	// use cosmos fork of keyring
	github.com/99designs/keyring => github.com/cosmos/keyring v1.2.0
	// Pin cometbft to v0.38.x for sr25519 compatibility. The patch level tracks
...
require (
	...
	github.com/nodelabs-sdk/nodelabs v0.0.0-20260806171542-b1a6d6574a5e
